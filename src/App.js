...
const cards = [
  {
    id: nanoid(),
    question: "Are penguins able to fly?",
  ...
  {
    id: nanoid(),
    question: "What do penguins like the most?",
    answer: "Fish",
    tags: ["penguins", "food"],
    bookmarked: false,
  },
  {
    id: nanoid(),
    question: "Do penguins live north or south of the equator?",
    answer: "South",
    tags: ["penguins"],
    bookmarked: true,
  },
  ...
  return (
      <Routes>
        <Route path="/" element={<Layout />}>
          <Route index element={<Home cards={cardArray} onDelete={deleteCard} onToggle={toggleBookmark}/>}/>
          <Route path="details/:id" element={<CardDetails cards={cardArray} onDelete={deleteCard} onToggle={toggleBookmark} />}/>    
